...
async function addEntity(
  ...
  if (!triplesOnly) {
    if (
      ...
      console.log("Overriding default configuration...");
      ...
      accessees.forEach((entity) => {
        ...
        newAclStore.add(makeNewAccessTriples(newAclStore, entity));
      });
      await client.updater.update([], newAclStore.statementsMatching());
